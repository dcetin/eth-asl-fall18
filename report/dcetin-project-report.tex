...
\hline
num & \multicolumn{4}{ |c| }{Model outputs} & \multicolumn{4}{ |c| }{Middleware meas.} \\
\cline{2-9}
...
\bibitem{queueing} A Queueing Package for GNU Octave \url{https://www.moreno.marzolla.name/software/queueing/}
\end{thebibliography}
