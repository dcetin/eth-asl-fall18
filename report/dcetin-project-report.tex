...
\hline Reads: Meas. on mw       & $2969.3 \pm 1.5$  & $5.413 \pm 0.021$  & $0.406 \pm 0.011$  &     \\ 
\hline Reads: Meas. on clients  & $2969.3 \pm 1.8$  & $8.083 \pm 0.004$  & n/a                &     \\ 
...
\begin{tabular}{|l|p{2.3cm}|p{2.3cm}|p{2.3cm}|p{2.3cm}|}
\hline                      & Throughput         & Response time      & Avg. time in queue & Miss rate \\ 
\hline Reads: Meas. on mw       & $2964.3 \pm 0.3$   & $2.288 \pm 0.061$  & $0.181 \pm 0.001$  &         \\ 
\hline Reads: Meas. on clients  & $2964.4 \pm 0.8$   & $6.077 \pm 0.002$  & n/a                &         \\ 
...
\end{subfigure}
\caption{Throughput and latency values for the full system experiment, write-only workload.}
\label{fig:tpfw_mw}
\end{figure}
...
\end{subfigure}
\caption{Average queue lengths, queue times and waiting times for the full system experiment, write-only workload.}
...
\end{subfigure}
\caption{Throughput and latency values for the auxiliary experiment, write-only workload with 64 worker threads on middlewares. tpfw stands for the full systems experiment, whereas the mwb2 denotes the middleware baseline experiment with two baselines.}
...
\hline 
\end{tabular}
\caption{Summary of the full system experiments.} \label{tab:tpfw-summary}
\end{table}
