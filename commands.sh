# Addresses
	...
	Client 2:		10.0.0.10
	Client 3:		10.0.0.7
	Middleware 1:	10.0.0.4
	Middleware 2:	10.0.0.11
	Server 1:		10.0.0.5
	Server 2:		10.0.0.9
	Server 3:		10.0.0.8
...
# BASELINE 1
	...
	# Copy results
	SSH_AUTH_SOCK=0  scp -r dcetin@storej3ybtf5b6wunqsshpublicip1.westeurope.cloudapp.azure.com:/home/dcetin/asl-fall18-project/res /home/doruk/Desktop/client1res
	SSH_AUTH_SOCK=0  scp -r dcetin@storej3ybtf5b6wunqsshpublicip2.westeurope.cloudapp.azure.com:/home/dcetin/asl-fall18-project/res /home/doruk/Desktop/client2res
	SSH_AUTH_SOCK=0  scp -r dcetin@storej3ybtf5b6wunqsshpublicip3.westeurope.cloudapp.azure.com:/home/dcetin/asl-fall18-project/res /home/doruk/Desktop/client3res
	# Merge results
